...
<body bgcolor="white" text="black">
  <font face="Times New Roman">
   ...
   <p>
    ...
    <ul>
      <li>Trusted with strategic client communication across 4 client product managers and 3 IT SMEs across 3 product areas</li>
      <li>Drove resolution of 3 complex technical issues diplomatically and swiftly resulting in increased service sales</li>
      <li>Restructured and drove a team of 4 to deliver 3 program deliverables within the last 3 months of a 6-month program</li>
    ...
    <ul>
      <li>Collaborated within several matrixed three-vendor programs to deliver Salesforce software enhancements</li>
    ...
    <ul>
      <li>Drove sales forecasting across 3 segments in NA with VP of Sales and presented weekly report to CRO</li>
      <li>Led program to collect and present quarterly business reviews resulting in systematic goal creation and tracking</li>
    ...
    <ul>
      <li>Designed and ran a qualitative study and presented findings to leadership across solutions engineering, marketing, enablement, and sales ops to gather customer stories—identifying 5 new customer-based marketing stories</li>
    ...
    <p>
      ...
      Interests/Hobbies: Surfing in Santa Cruz and Pacifica, hiking in Marin or parks of San Francisco
    </p>
  </font>
</body>
</html>
